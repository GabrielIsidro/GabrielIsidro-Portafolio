...
export default function ProjectCard({ project }) {
    ...
    return (
        <Tilt
            ...
            className="h-full"
        >
            <div className="bg-tarjeta border border-tarjeta rounded-xl p-6 hover:border-acento hover:shadow-[0_0_30px_rgba(56,189,248,0.15)] transition-colors duration-300 flex flex-col h-full">
                <div className="mb-4">
