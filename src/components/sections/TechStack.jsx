...
export default function TechStack() {
    ...
    return (
        <section id="habilidades" className="py-20 bg-fondo px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {skills.map((skillGroup, index) => (
                        <Tilt
                            ...
                            className="h-full"
                        >
                            <div className="bg-tarjeta rounded-2xl p-8 border border-gray-800 hover:border-acento/50 transition-colors shadow-lg h-full">
                                {/* Título centrado */}
